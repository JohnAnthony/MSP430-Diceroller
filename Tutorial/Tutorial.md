...
2) Compile all of your objects (just on in this case) into an appropriately formatted ELF file using msp430-gcc. be sure to change your target architecture if you're using a slightly different chip. yes, this is important because different chips use different offsets for locations of data within the elf file. This is the file we will be using on our chip and the compiling process really is as easy as just that.
